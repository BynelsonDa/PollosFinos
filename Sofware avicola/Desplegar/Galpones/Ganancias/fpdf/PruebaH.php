...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $consulta_info = $bd->query("SELECT * FROM ganancias"); // Fetch data from the 'aves' table
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE GANANCIAS "), 0, 1, 'C', 0);
      $this->Ln(7);
      ...
      $this->Cell(40, 10, utf8_decode('Galpon'), 1, 0, 'C', 1);
      $this->Cell(40, 10, utf8_decode('Origen'), 1, 0, 'C', 1);
      $this->Cell(80, 10, utf8_decode('Fecha'), 1, 0, 'C', 1);
      $this->Cell(70, 10, utf8_decode('ganancia'), 1, 1, 'C', 1);
...
$consulta_info = $bd->query("SELECT * FROM ganancias");
...
$consulta_reporte_asistencia = $bd->query(" SELECT * FROM ganancias ");
...
while ($datos_reporte = $consulta_reporte_asistencia->fetch(PDO::FETCH_OBJ)) {
   ...
   $pdf->Cell(40, 10, utf8_decode($datos_reporte->Galpon), 1, 0, 'C', 0);
   $pdf->Cell(40, 10, utf8_decode($datos_reporte->Origen), 1, 0, 'C', 0);
   $pdf->Cell(80, 10, utf8_decode($datos_reporte->Fecha), 1, 0, 'C', 0);
   $pdf->Cell(70, 10, utf8_decode($datos_reporte->Ganancia), 1, 1, 'C', 0);
