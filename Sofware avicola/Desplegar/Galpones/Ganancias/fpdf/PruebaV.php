...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(40, 10, utf8_decode('huevos'), 1, 0, 'C', 1);
...
$i = $i + 1;
/* TABLA */
$pdf->Cell(15, 10, utf8_decode("id"), 1, 0, 'C', 0);
$pdf->Cell(40, 10, utf8_decode("nombre"), 1, 0, 'C', 0);
$pdf->Cell(40, 10, utf8_decode("especie"), 1, 0, 'C', 0);
$pdf->Cell(40, 10, utf8_decode("genero"), 1, 0, 'C', 0);
$pdf->Cell(30, 10, utf8_decode("galpon"), 1, 0, 'C', 0);
$pdf->Cell(40, 10, utf8_decode("huevos"), 1, 0, 'C', 0);
$pdf->Cell(50, 10, utf8_decode("fecha"), 1, 1, 'C', 0);
